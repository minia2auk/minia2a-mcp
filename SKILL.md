---
name: minia2a-mcp
description: Discover, trial, and pay for 1,000+ x402-payable APIs on the minia2a marketplace. Built-in USDC micropayments on Base L2. No API keys required.
metadata:
  type: marketplace
...
Connects AI agents to the [minia2a.uk](https://minia2a.uk) marketplace — a live platform where agents discover, trial, and pay for 1,000+ API services using the x402 protocol (HTTP 402 Payment Required).

## What agents can do

- **Discover services** — Browse 1,000+ x402-payable APIs across crypto, AI, web, data, and more
