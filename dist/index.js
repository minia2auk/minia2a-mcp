...
// ── Tool: get_stats ──────────────────────────────────────────────────
server.tool("minia2a_get_stats", "Get current platform statistics for minia2a.uk — total services, registered agents, transaction volume, uptime, and more. Useful for understanding the marketplace's scale and health.", {}, async () => {
...
// ── Tool: call_service ───────────────────────────────────────────────
server.tool("minia2a_call_service", "Call an x402 service on minia2a.uk. The x402 protocol handles micropayment automatically — you pay per call in USDC. The response includes the service output and payment confirmation.", {
    serviceId: z
        .string()
                ...
                content: [
                    {
                        ...
                        text: JSON.stringify({
                            ...
                            message: "This service requires credits. Register at https://minia2a.uk to get free trial credits.",
                            payment_details: paymentInfo,
                            action: "Visit https://minia2a.uk/register to create an account and receive free credits.",
                        }, null, 2),
                    },
                ],
            };
